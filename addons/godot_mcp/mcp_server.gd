...
func _enter_tree():
	...
	# Register MCPTestServer autoload for runtime testing
	var autoload_path := "*res://addons/godot_mcp/runtime/test_server.gd"
	if not ProjectSettings.has_setting("autoload/MCPTestServer"):
		ProjectSettings.set_setting("autoload/MCPTestServer", autoload_path)
		ProjectSettings.save()
		print("Registered MCPTestServer autoload")
...
func _exit_tree():
	...
	# Remove MCPTestServer autoload
	if ProjectSettings.has_setting("autoload/MCPTestServer"):
		ProjectSettings.set_setting("autoload/MCPTestServer", null)
		ProjectSettings.save()
		print("Removed MCPTestServer autoload")

...
func _initialize_command_processors():
	...
	var log_commands = MCPLogCommands.new()
	var runtime_commands = MCPRuntimeCommands.new()
	...
	log_commands._websocket_server = _websocket_server
	runtime_commands._websocket_server = _websocket_server
	...
	_command_processors.append(log_commands)
	_command_processors.append(runtime_commands)
	...
	add_child(log_commands)
	add_child(runtime_commands)
